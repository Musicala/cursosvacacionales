...
import { el, toast, modal } from "../ui.js?v=3";
import { listar, actualizar, obtenerTemporada, actualizarTemporada } from "../db.js?v=3";
import { RUTA_MINIMO } from "../catalogos.js?v=3";
