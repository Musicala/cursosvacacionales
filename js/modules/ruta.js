...
import { el, toast, modal } from "../ui.js?v=2";
import { listar, actualizar, obtenerTemporada, actualizarTemporada } from "../db.js?v=2";
import { RUTA_MINIMO } from "../catalogos.js?v=2";
