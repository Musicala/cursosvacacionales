...
import { el, cop, toast, modal, fmtFecha, fmtCorta } from "../ui.js?v=2";
import { obtenerTemporada, actualizarTemporada } from "../db.js?v=2";
import { PAQUETES, RUTA_MINIMO, DIAS, DIAS_POSIBLES, NUM_SEMANAS_DEFAULT, semanasDetalle } from "../catalogos.js?v=2";
